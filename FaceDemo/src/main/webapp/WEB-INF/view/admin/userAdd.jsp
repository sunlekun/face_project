...
<body class="mainbody">
<form method="post" action="user/userAdd" id="form1" enctype="multipart/form-data">
 
 <input type="hidden" name="flag" id="flag" value="1" />
 
 <input type="hidden" name="isHasVideo" id="isHasVideo" value="${isHasVideo}" />
...
<!--导航栏-->
<div class="location">
  <a href="user/toUserList" class="back"><i class="iconfont icon-up"></i><span>返回列表页</span></a>
  <a href="manager/center"><i class="iconfont icon-home"></i><span>首页</span></a>
  <i class="arrow iconfont icon-arrow-right"></i>
  <a href="user/toUserList"><span>居民信息采集列表</span></a>
  <i class="arrow iconfont icon-arrow-right"></i>
  <span>居民信息采集</span>
</div>
