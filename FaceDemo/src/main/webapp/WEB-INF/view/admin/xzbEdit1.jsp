...
<body class="mainbody">
<form method="post" action="xzb/xzbEdit" id="form1" > 
...
<input type="hidden" name="id" id="id" value="${xzb.id }" />
  <%-- <dl>
    <dt>名称</dt>
  ...
  <dl>
    <dt>标题：</dt>
    <dd>
      <input name="title" type="text" value="${xzb.title }" maxlength="100" id="title" class="input normal" datatype="*1-100" sucmsg=" " minlength="2" />
