            ...
            success: function (data, status) {
                ...
                var tabledata=strs.jsons;
                    ...
                    $('#table').on('dbl-click-row.bs.table',function(row, $element) {
                       window.location.href = "<%=path%>/xzb/xzbDetial?id="+$element.id;                  
 ...
 <%--  return "<a class='update'  href = '<%=path%>/xzb/toXzbEdit?id="+value+"'>修改</a><br>" ; --%>
    ...
    window.actionEvents = {
     'click .update': function(e, value, row, index) {   
          //修改操作
          window.location.href = "<%=path%>/xzb/toXzbEdit?id="+value;
      } 
     } 
     
      function Search(){
     document.getElementById("form1").action="<%=path%>/xzb/toXzbList"; 
   ...
   function deleteDiaryList() {  
    ...
    if (rows.length== 0) {  
     ...
     if(con==true)
     {
      ...
      if(from!=null){
        from.action="<%=path%>/xzb/xzbDelete"; 
        from.submit();
       }  
...
<body class="mainbody">
<form method="post"  action="<%=path%>/xzb/toXzbList"  id="form1">
  ...
  <table width="100%"    id="table"  
        ...
        <tr>
            ...
            <th data-sortable="true" data-field="title" data-align="center"
                data-filter-control="input">名称
            </th>
            
            <th data-sortable="true" data-field="sort" data-align="center"
                data-filter-control="input">排序
            </th>             
