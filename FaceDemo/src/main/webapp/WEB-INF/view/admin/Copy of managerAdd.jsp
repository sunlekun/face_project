...
<script type="text/javascript">
 ...
 <%--     $(function () {
       $(".mainbody").Validform({
        ...
        $.ajax(
            {
                url:"<%=path%>/manager/isExistUserName",
...
<body class="mainbody">
<form method="post" action="manager/add" id="form1">
 ...
 <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
          <span id="rblType">
          <input id="rblType_0" type="radio" name="rblType" value="机关事业养老保险" onclick="changes('0')" checked="checked" /><label for="rblType_0">机关事业养老保险</label>
          <input id="rblType_1" type="radio" name="rblType" value="城乡居民养老保险" onclick="changes('1')" /><label for="rblType_1">城乡居民养老保险</label>
          <input id="rblType_2" type="radio" name="rblType" value="企业职工养老保险" onclick="changes('2')" /><label for="rblType_2">企业职工养老保险</label>
          </span>
      </div>
    </dd>
  </dl>
  ...
  <dl id="div_xzb" style="display: none;">
    ...
    <dd>
      <div class="rule-single-select">
        <select name="xzb" id="xzb" datatype="*" errormsg="请选择所属乡镇办" sucmsg=" ">
