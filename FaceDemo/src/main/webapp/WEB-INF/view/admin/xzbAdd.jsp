...
<body class="mainbody">
<form method="post" action="xzb/xzbAdd" id="form1">
...
<div class="tab-content">
  <dl>
    <dt>名称</dt>
    <dd><input name="title" type="text" id="title" class="input normal" datatype="*2-100" sucmsg=" " /> <span class="Validform_checktip">*与Excel数据中保持一致</span></dd>
  </dl> 
  <dl>
    <dt>排序数字</dt>
    <dd>
      <input name="sort" type="text" value="99" id="sort" class="input small" datatype="n" sucmsg=" " />
