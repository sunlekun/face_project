...
function infoFormatter( value, row, index){ 
 ...
 var s="<shiro:hasPermission name='tempUser:Edit'><a class='detial'  href = 'tempUser/tempUserEdit?id="+row['id']+"'>"+row['user_name']+"</a></shiro:hasPermission>"+
...
<%-- <div id="floatHead" class="toolbar-wrap">
  <div class="toolbar"  id="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="<%=path %>/tempUser/toTempUserAdd"><i></i><span>新增</span></a></li>
