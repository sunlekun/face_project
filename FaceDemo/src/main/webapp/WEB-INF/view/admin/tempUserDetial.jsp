...
<body class="mainbody">
<form method="post" action="tempUser/tempUserAdd?status=${status}&dataType=${dataType}&type=${type}" id="form1" enctype="multipart/form-data">
...
<div class="tab-content">
 ...
 <c:if test="${!empty tempUser}">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <select name="ddlGroupId" id="ddlGroupId" datatype="*" ignore="ignore" errormsg="请选择乡镇办" sucmsg=" " disabled="false">
