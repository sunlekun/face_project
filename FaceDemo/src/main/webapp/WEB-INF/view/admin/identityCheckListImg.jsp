   ...
   var ids = '';
    ...
    {  
     ...
     if(con==true)
     {
      ...
      if(from!=null){
        from.action="identityCheck/identityCheckDelete?status=${status}"; 
        from.submit();
       }  
...
<body class="mainbody">
<form method="post"  action="identityCheck/toIdentityCheckList?type=${type}"  id="form1">
...
<div class="table-container">
  ...
  <li>
        <div class="details">
          ...
          <div class="pic"><img src="css/admin/skin/default/loadimg.gif" data-original="${videoIdent.img_url}?w=228&h=165&mode=crop" /></div><i class="absbg"></i>
          <h1>
	          <span>
	          <shiro:hasPermission name="identityCheck:Edit">
	             	  <a href="identityCheck/toTempUserAuditEdit?status=${status}&type=${type }&id=${ videoIdent.id}" >${ videoIdent.user_name}</a>
	            </shiro:hasPermission>
          ...
          <div class="foot">
            ...
            <shiro:hasPermission name="identityCheck:Edit">
             	  <a href="identityCheck/toTempUserAuditEdit?status=${status}&type=${type }&id=${ videoIdent.id}" title="编辑资料"><i class="iconfont icon-pencil"></i></a>
            </shiro:hasPermission>
            <shiro:lacksPermission name="identityCheck:Edit">
            ...
            <shiro:hasPermission name="identityCheck:View">
          	 	 <a href="identityCheck/identityCheckDetial?status=${status}&type=${type }&id=${ videoIdent.id}" title="详情"><i class="iconfont icon-eye"></i></a> 
            </shiro:hasPermission>
