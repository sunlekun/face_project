 ...
 <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
          <span id="rblType">
          <input id="rblType_0" type="radio" name="rblType" value="机关事业养老保险" checked="checked" /><label for="rblType_0">机关事业养老保险</label>
          <input id="rblType_1" type="radio" name="rblType" value="城乡居民养老保险" onclick="javascript:setTimeout('__doPostBack(\'rblType$1\',\'\')', 0)" /><label for="rblType_1">城乡居民养老保险</label>
          <input id="rblType_2" type="radio" name="rblType" value="企业职工养老保险" onclick="javascript:setTimeout('__doPostBack(\'rblType$2\',\'\')', 0)" /><label for="rblType_2">企业职工养老保险</label>
          </span>
      </div>
    </dd>
  </dl>
  ...
  <dl id="div_Township">
    ...
    <dd>
      <div class="rule-single-select">
        <select name="ddlTownshipId" id="ddlTownshipId" datatype="*" errormsg="请选择所属乡镇办" sucmsg=" ">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <input id="is_lock" type="checkbox" name="is_lock" checked="checked" />
      </div>
  ...
  <dl>
    <dt>用户名</dt>
    <dd><input name="user_name" type="text" value="system" id="user_name" class="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=manager_validate" /> <span class="Validform_checktip">*字母、下划线，不可修改</span></dd>
  </dl> 
  <dl>
    <dt>登录密码</dt>
